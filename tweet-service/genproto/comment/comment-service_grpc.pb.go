...
const (
	...
	CommentService_GetCommentsForTweet_FullMethodName = "/comment.CommentService/GetCommentsForTweet"
)
...
type CommentServiceClient interface {
	// User creates a comment for a specific tweet
	CreateComment(ctx context.Context, in *CreateCommentRequest, opts ...grpc.CallOption) (*CreateCommentResponse, error)
	// User deletes a comment
	DeleteComment(ctx context.Context, in *DeleteCommentRequest, opts ...grpc.CallOption) (*DeleteCommentResponse, error)
	// Get all comments for a specific tweet
	GetCommentsForTweet(ctx context.Context, in *GetCommentsForTweetRequest, opts ...grpc.CallOption) (*GetCommentsForTweetResponse, error)
}
...
func (c *commentServiceClient) GetCommentsForTweet(ctx context.Context, in *GetCommentsForTweetRequest, opts ...grpc.CallOption) (*GetCommentsForTweetResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetCommentsForTweetResponse)
	err := c.cc.Invoke(ctx, CommentService_GetCommentsForTweet_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CommentServiceServer interface {
	...
	// Get all comments for a specific tweet
	GetCommentsForTweet(context.Context, *GetCommentsForTweetRequest) (*GetCommentsForTweetResponse, error)
...
func (UnimplementedCommentServiceServer) GetCommentsForTweet(context.Context, *GetCommentsForTweetRequest) (*GetCommentsForTweetResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetCommentsForTweet not implemented")
}
...
func _CommentService_GetCommentsForTweet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetCommentsForTweetRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CommentServiceServer).GetCommentsForTweet(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CommentService_GetCommentsForTweet_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CommentServiceServer).GetCommentsForTweet(ctx, req.(*GetCommentsForTweetRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CommentService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetCommentsForTweet",
			Handler:    _CommentService_GetCommentsForTweet_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "comment-service/comment-service.proto",
}
